...
public:
    ...
    double alpha, lambda; // LDA hyperparameters 
    ...
    double ** beta; // beta: topic-word distributions, size K x V
    ...
    // model_name.beta: topic-word distributions
    // model_name.others: containing other parameters of the model (alpha, lambda, M, V, K)
    int save_model(string model_name);
    int save_model_tassign(string filename);
    int save_model_theta(string filename);
    int save_model_beta(string filename);
    ...
    int save_inf_model_newbeta(string filename);
